  ...
  Future<void> _submit() async {
    ...
    try {
      ...
      for (int i = 0; i < _imagePaths.length; i++) {
        await api.uploadPropertyImage(property.id, _imagePaths[i], isPrimary: i == 0);
      }
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: const Text(
                'Property created! Submit it for review when ready.'),
        ...
        context.pop();
        // Navigate to the property detail so owner can review
            ...
            child: Padding(
              ...
              child: ElevatedButton(
                ...
                child: _isSaving
                    ...
                    : Text(_currentPage < 3 ? 'Continue' : 'Create Listing'),
              ),
            ),
          ),
        ],
